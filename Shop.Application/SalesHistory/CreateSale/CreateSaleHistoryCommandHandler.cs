...
public sealed class CreateSaleHistoryCommandHandler : IRequestHandler<CreateSaleHistoryCommand, ApiResult<SaleHistoryDto>>
{
    ...
    public CreateSaleHistoryCommandHandler(IUnitOfWork unitOfWork, ISaleHistoryRepository saleHistoryRepository, IMapper mapper)
    ...
    {
        var entity = SaleHistory.Create(request.ClientName, request.Quantity, request.PricePerUnit, request.ProductId);
