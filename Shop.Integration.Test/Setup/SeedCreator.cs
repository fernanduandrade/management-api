...
//         {
//             new SalesHistory { Id = new Guid(), Quantity = 2, Date = DateTime.UtcNow, ClientName = "Andrade", TotalPrice = 20, PricePerUnit = 120, ProductId = new Guid() },
//             new SalesHistory { Id = new Guid(), Quantity = 1, Date = DateTime.UtcNow, ClientName = "Andrade", TotalPrice = 40, PricePerUnit = 40, ProductId = new Guid() },
//             new SalesHistory { Id = new Guid(), Quantity = 2, Date = DateTime.UtcNow, ClientName = "Andrade", TotalPrice = 4, PricePerUnit = 2, ProductId = new Guid() },
//             new SalesHistory { Id = new Guid(), Quantity = 2, Date = DateTime.UtcNow, ClientName = "Andrade", TotalPrice = 8, PricePerUnit = 4, ProductId = new Guid() },
//             new SalesHistory { Id = new Guid(), Quantity = 1, Date = DateTime.UtcNow, ClientName = "Andrade", TotalPrice = 120, PricePerUnit = 120, ProductId = new Guid() },
//         };
//
